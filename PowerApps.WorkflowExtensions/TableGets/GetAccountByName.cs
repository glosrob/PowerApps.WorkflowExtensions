...
namespace PowerApps.WorkflowExtensions.TableGets
{
    ...
    /// </summary>
    public class GetAccountByName : WorkflowServiceBase
    {
        //Properties
        ...
        /// <summary>
        /// Gets or sets the Account found.
        /// </summary>
        [Output("Account")]
        ...
        public override void ExecuteWf(WorkflowHelper worker)
        {
            ...
            var result = worker.TableGet.GetAccountByName(name);
            Account.Set(worker.ActivityContext, result);
        }
    }
}
